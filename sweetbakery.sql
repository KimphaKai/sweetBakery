...
--
-- Host: localhost:8889
-- Generation Time: Mar 06, 2022 at 03:15 AM
...
(7, 4, 'https://firebasestorage.googleapis.com/v0/b/sweetbakeryimg.appspot.com/o/cake%201-2.jpeg?alt=media&token=68c08e10-951e-11ec-8089-ab5250c11d0f'),
(8, 4, 'https://firebasestorage.googleapis.com/v0/b/sweetbakeryimg.appspot.com/o/cake%201-1.jpeg?alt=media&token=68c08e10-951e-11ec-8089-ab5250c11d0f'),
...
('Ajch2OZmjWwqhrKjfP7aVh8AvCswevt4', 'c@gmail.com', '123', 'c', '0912312323', '2022-03-31', '', ''),
('dede', 'cosmo4956@gmail.com', '123456', '李慧婷', '', '1999-02-17', '', ''),
('gFqqtpgX-qrdNaH3Hr2HpMR-NUEn7Gir', 'c@gmail.com', '123', 'c', '0912391239', '1997-06-17', '', ''),
...
(10001, 1, 7, '糖果奶油蛋糕', '焦糖口味', 250, '雞蛋、牛奶、動物鮮奶油、低筋麵粉、比利時鈕扣調溫巧克力、奶油、砂糖、吉利丁', '上架中'),
(10002, 1, 7, '巧克力蛋糕', '台灣第一款 如香水般有豐富層次的頂級巧克力蛋糕\r\n入口前味微苦的巧克力，\r\n中段帶有濃郁的咖啡香!', 350, '雞蛋、牛奶、動物鮮奶油、低筋麵粉、比利時鈕扣調溫巧克力、奶油、砂糖、吉利丁', '上架中'),
(10003, 1, 7, '草莓蛋糕', '草莓蛋糕\r\n草莓蛋糕\r\n草莓蛋糕', 350, '草莓蛋糕\r\n草莓蛋糕\r\n草莓蛋糕', '下架中'),
...
(30002, 3, 5, '草莓果醬餅乾', '草莓果醬餅乾', 500, '草莓果醬餅乾', '上架中');
...
(20001, 'https://firebasestorage.googleapis.com/v0/b/sweetbakeryimg.appspot.com/o/cupcake%201-3.jpeg?alt=media&token=d97c2ad4-deb7-46f1-8aee-d10e7e576de9', 7),
(20001, 'https://firebasestorage.googleapis.com/v0/b/sweetbakeryimg.appspot.com/o/cupcake%201-3.jpeg?alt=media&token=d97c2ad4-deb7-46f1-8aee-d10e7e576de9', 8),
(20001, 'https://firebasestorage.googleapis.com/v0/b/sweetbakeryimg.appspot.com/o/cupcake%201-1.jpg?alt=media&token=7ede4d42-9003-4797-98e7-a3c454c667ed', 9),
...
--
ALTER TABLE `classimg`
  MODIFY `classImgId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `classlist`
--
ALTER TABLE `classlist`
  MODIFY `classId` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `productimg`
  MODIFY `productImgId` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
